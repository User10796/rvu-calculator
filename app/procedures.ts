...
export const procedureCategories: ProcedureCategory[] = [
  ...
  },
  {
    ...
    procedures: [
      ...
      { code: '64454', name: 'Articular branches fem/obt nerves', rvu: 1.52, bilateral: true },
    ],
  },
  {
  ...
  },
  {
    ...
    procedures: [
      ...
      { code: '64520', name: 'Lumbar Sympathetic Block', rvu: 1.35, bilateral: true },
      { code: '64510', name: 'Stellate Ganglion Block', rvu: 1.22, bilateral: true },
    ],
  },
  {
    ...
    procedures: [
      ...
      { code: '20604', name: 'Small Joint WITH u/s', rvu: 1.00, bilateral: true },
      { code: '20550', name: 'Tendon Origin/Insertion', rvu: 0.67, bilateral: true },
      { code: '20526', name: 'Carpal Tunnel Injection', rvu: 0.75, bilateral: true },
    ],
  },
  {
    ...
    procedures: [
      ...
      { code: '64461', name: 'Paravertebral Block 1st Level', rvu: 1.75, bilateral: true },
      { code: '64462', name: 'Paravertebral Block 2nd+ Level', rvu: 1.10, bilateral: true },
      { code: '64450+64447', name: 'II/IH Block w/ u/s', rvu: 1.85, bilateral: true },
      { code: '64420', name: 'ICNB 1st Level', rvu: 1.08, bilateral: true },
      { code: '64421', name: 'ICNB 2nd+ Level', rvu: 0.55, bilateral: true },
      { code: '64418', name: 'Suprascapular Nerve Block', rvu: 1.10, bilateral: true },
      { code: '64450', name: 'Peripheral Nerve Block', rvu: 0.75, bilateral: true },
